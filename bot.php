			...
			if(isset($update->message)){
				...
				if($chatId == $id){
                 ...
                 $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://th.bing.com/th/id/OIP.OC_xVskADctzQZAXXLTp0gHaHa?pid=ImgDet&w=1080&h=1080&rs=1",
'caption'=>"- Welcome .\n- To Your IG Hunter Tool . BY - @freesimping .",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'- Add New Acc ⬇️ .','callback_data'=>'login']],
                          [['text'=>'- Make Fake Account 🤖 .','callback_data'=>'fmake']], 
                          [['text'=>'freesimping . ','url'=>'t.me/freesimping']], 
                      ]
                  ])
              ]);   
          } elseif($text != null){
           ...
           'text'=>"-Welcome .\n- To Your IG Hunter Tool .\n\n BY - @freesimping .",
                  'reply_markup'=>json_encode([
					...
					$bot->sendMessage([
							'chat_id'=>$chatId,
							'text'=>"paid instagram hunter ",
							'reply_markup'=>json_encode([
                  'inline_keyboard'=>[
                      [['text'=>'• click here to buy','url'=>'t.me/freesimping']]
                  ]
							])
					]);
				}
