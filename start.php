...
$edit = bot('sendMessage',[
    ...
    'reply_markup'=>json_encode([
            'inline_keyboard'=>[
				...
				[['text'=>'- No Reset 🚫. : '.$freesimpinga,'callback_data'=>'freesimpinga']],
				[['text'=>'- Blacklist 💡. : '.$bfreesimping,'callback_data'=>'bfreesimping']],
                       ...
                       if(checkMail($mail)){
                        ...
                        if ($inInsta == "Good") {
                            // if($config['filter'] <= $follow){
                                ...
                                $following = $info['ff'];
                                $media = $info['m'];
                                                                bot('sendMessage', [ 'disable_web_page_preview' => true, 'chat_id' => $id, 'text' => "•ℍ𝕌ℕ𝕋𝔼ℝ َ،'👇  ، ✓\n- - - - - - - - - - - - - - - - - - - -\n.☢️. 𝐔𝐒𝐄𝐑 : [$usern](instagram.com/$usern)\n.☢️. 𝐄𝐌𝐀𝐈𝐋 : [$mail] \n.☢️. 𝐅𝐨𝐥𝐥𝐨𝐰𝐞𝐫𝐬 : $follow \n.☢️. 𝐅𝐨𝐥𝐥𝐨𝐰𝐢𝐧𝐠 : $following\n.☢️. 𝐏𝐎𝐒𝐓 : $media\n- - - - - - - - - - - - - - - - - - - -\nTele:- [freesimping 🛃](https://t.me/freesimping)",
